...
namespace ProcolombiaPQRTest.Controllers
{
    ...
    public class RoleControllerTest
    {
        ...
        public void Setup()
        {
            ...
            _dbContext.Role.AddRange(new[]
            {
                new RoleEntity { Id = Guid.Parse("636a919e-627a-4fb4-990d-7f942914b555"), Name = "Type 1" },

            });
            _dbContext.SaveChanges();

            // Crear la instancia del controlador a probar
            _controller = new RoleController(_dbContext);
        }
        ...
        public async Task GetAll_ReturnsOkResultWithCorrectData()
        {
            ...
            var response = okResult.Value as RoleController.RoleResponse;
